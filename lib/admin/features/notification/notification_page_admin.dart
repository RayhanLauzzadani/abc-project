...
import 'package:abc_e_mart/admin/features/approval/store/admin_store_approval_detail_page.dart'; // Pastikan import benar
        ...
        builder: (context, snapshot) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final isCancel = data['status'] == 'rejected';
              ...
              return GestureDetector(
                onTap: () async {
                  ...
                  if (data['shopApplicationId'] != null && (data['shopApplicationId'] as String).isNotEmpty) {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Icon(
                          isCancel ? Icons.close_rounded : Icons.notifications_active_rounded,
